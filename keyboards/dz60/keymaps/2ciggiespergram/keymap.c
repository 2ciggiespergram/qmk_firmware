...
/* Oldmate's tip-top keymap
 *
 * Alt key press = one-shot layer 1, Alt key hold = regular Alt
 * by Oldmate the madcunt
 */
...
/* Qwerty
    ...
    * |-----------------------------------------------------------------------------------------+
    * | Ctrl |  Win  |  Alt  |               Space                | Ctrl | Fn |  L  |  D  |  R  |
    * `-----------------------------------------------------------------------------------------'
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_directional(
		...
		KC_LCTL, KC_LGUI, TD(ALT_OSL1), KC_SPC, KC_SPC, KC_SPC, KC_RCTL, MO(1), KC_LEFT, KC_DOWN, KC_RGHT),

	[1] = LAYOUT_directional(
		KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TRNS, KC_TRNS,
		KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,
		...
		KC_TRNS, KC_TRNS, TD(ALT_OSL1), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_TRNS)
};
